...
import {
    ...
    PRODUCTS_BY_CATEGORY_GET_LIST_REQUEST,
    PRODUCTS_BY_CATEGORY_GET_LIST_RESPONSE,
    PRODUCTS_BY_CATEGORY_GET_LIST_FAILURE,
...
// State
export const productsByCategoryState = (state = productsInitialState, action) => {
    switch (action.type) {
        case PRODUCTS_BY_CATEGORY_GET_LIST_REQUEST:
            return {
                ...state,
                isLoading: action.isLoading,
                error: null
        ...
        case PRODUCTS_BY_CATEGORY_GET_LIST_RESPONSE:
            return {
                ...state,
                isLoading: false,
                error: action.error,
        ...
        case PRODUCTS_BY_CATEGORY_GET_LIST_FAILURE:
            return {
                ...state,
                isLoading: false,
                error: action.error
