  ...
  render() {
    const steps = [
      ...
      <Grid alignCenter={true} style={{ height: '100%', textAlign: 'center', color: white }}>
        ...
        <GridCell>
          <H1 font="secondary" style={{ textShadow: textLevel1 }}>Weblcome at La Centrale Agricole</H1>

          <H6 style={{ marginTop: '0.5em' }}>The first Moroccain<br/> Agricultural MarketPlace </H6>
