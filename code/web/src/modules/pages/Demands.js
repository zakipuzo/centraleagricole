...
class Demands extends PureComponent {
  ...
  static fetchData({ store }) {
    return store.dispatch(getProductList(2))
  }

  // Runs on client only
  componentDidMount() {
    this.props.getProductList(2);
  ...
  onClickLoadMore = () => {
    ...
    this.props.getMoreProducts(productId, 2)
      ...
      <div>
        ...
        <Grid style={{ backgroundColor: grey }} >
          <GridCell alignCenter={true} style={{ padding: '2em',  textAlign: 'center'  }}>
            <H3 font="secondary">Demands</H3>

            <p style={{ marginTop: '1em', color: grey2 }}>Watch this space to keep updated with latest Demands.</p>
          </GridCell>
        </Grid>
...
export default connect(DemandsState, { getProductList, getMoreProducts, messageShow})(Demands)
